...
# Integrante B
from combustible.combustible import calcular_combustible  # ← CORREGIDO
# Integrante C
from eta import calcular_eta
...
def main():
    ...
    combustible = calcular_combustible(distancia, rendimiento)  # ← CORREGIDO
